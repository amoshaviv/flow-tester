...
export default function ProjectMenu(props: { project: ProjectData, organizationSlug: string, organizationProjects: ProjectData[] }) {
  const { project, organizationProjects, organizationSlug } = props;
      ...
      >
        <ListItem disablePadding>
          <ListItemButton
            ...
            component={Link}
            href={`/${organizationSlug}/projects/new`}
          >
        ...
        (
          <ListItem key={organizationProject.slug} disablePadding>
            <ListItemButton
              onClick={handleCloseProjectMenu}
              component={Link}
              selected={project.slug === organizationProject.slug}
              href={`/${organizationSlug}/projects/${organizationProject.slug}`}
            >
              <ListItemText primary={organizationProject.name} />
            </ListItemButton>
          </ListItem>
        ))}
      </Menu>
